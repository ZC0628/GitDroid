...
import com.zc.githubdroid.commons.LoggingInterceptor;
...
public class GankClient implements GankApi{
    ...
    @Override
    public Call<GankResult> getDailyData
            (@Path("yaer") int year, @Path("month") int month, @Path("day") int day) {
